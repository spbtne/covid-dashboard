...
const accessToken = 'pk.eyJ1IjoiZHJlYW1lci1hIiwiYSI6ImNraXliMWdwMjN6YXUycWxiMng1YXY3cjEifQ.5WvajAdFAhL9b2wUJ4zkAg';

function mapBlock ( {countriesArr} ) {
    return (
      
        <MapContainer center={[0, 1]} zoom={2} scrollWheelZoom={true}>
        <TileLayer
        ...
        />
        <LayerGroup>
          {countriesArr.map((countryItem) => {
            return (
              <Circle
                center={[countryItem.countryInfo.lat, countryItem.countryInfo.long]}
